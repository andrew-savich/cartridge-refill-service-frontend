            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item">
                            <NavLink className="nav-link dropdown-toggle" onClick={() => {setShow(!isShow)}} to="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">Cartridges</NavLink>
                            <ul className={"dropdown-menu bg-light text-dark " + (isShow ? 'show' : '') } aria-labelledby="navbarDropdownMenuLink">
                                <li><NavLink className="dropdown-item" to="/groups" onClick={() => {setShow(false)}}>Groups</NavLink></li>
                                <li><NavLink className="dropdown-item" to="/models" onClick={() => {setShow(false)}}>Models</NavLink></li>
                            </ul>
                        </li>
                        <li className="nav-item">
